      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6" id="uploadImages">
            ...
            File folder = new File(whereFolder); String
            listOfTheNameOfTheFiles[] = folder.list(); if
            (listOfTheNameOfTheFiles.length == 3) { for (String element :
            listOfTheNameOfTheFiles) { request.setAttribute("element", element);
            %>
            <div>${element}</div>
            <% } } %>
          </div>
          <div class="col-sm-6">
            <form id="formAjout" action="/annonce/ajout" method="post">
              <div class="text-center">
                ...
                ></textarea>
                <br /><br />
                <label for="paysAnnonce">Pays: </label> <br /><input
                  type="text"
                  id="paysAnnonce"
                  name="paysAnnonce"
                />
                ...
                />
                <br /><br />
                <label for="codePostalAnnonce">Code Postal: </label><br />
                <input
                  type="text"
                  id="codePostalAnnonce"
                  name="codePostalAnnonce"
                />
                <br /><br />
                <label for="villeAnnonce">Ville: </label><br /><input
                  type="text"
                  id="villeAnnonce"
                  name="villeAnnonce"
                />
                <br />
                <br />
                <label for="date_debut_string">Date debut: </label> <br />
                <input type="date" name="date_debut_string" /> <br /><br />
                <label for="date_limite_string">Date de fin: </label><br />
                <input
                  type="date"
                  id="date_limite_string"
                  name="date_limite_string"
                />
                <br />
                <br />
              </div>
              <div class="descCS">
                Pour que l'annonce soit accepteée il est demandé de mettre: au
                moins un service et une contrainte
              </div>
              <p id="contraintes" class="descCS">
                ...
                <input
                  ...
                  id="deuxEnfantsMax"
                />
                <label for="deuxEnfantsMax"
                  >2 enfants maximum par logement</label
                >
                <br />
                <input type="checkbox" name="animaux" id="animaux" />
                <label for="animaux">Pas d'animaux </label> <br />
                <input type="checkbox" name="enfants" id="enfants" />
                <label for="enfants">Pas d'enfants autorisés</label> <br />
                <input
                  type="checkbox"
                  name="bruitVingtTrois"
                  id="bruitVingtTrois"
                />
                <label for="bruitVingtTrois">Pas de bruits après 23h</label>
                <br />
                <input type="checkbox" name="cigarette" id="cigarette" />
                <label for="cigarette">Pas de cigarettes</label> <br />
                <br />
              </p>
