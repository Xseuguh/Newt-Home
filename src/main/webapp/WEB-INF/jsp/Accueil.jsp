...
<body>
	...
	<div class="container">
		<div class="row rechercheSimple" id="rechercheDiv">
			<form action="/Accueil" method="post" class="form-inline">
				<input type="search" class="recherche" name="motCle" value="${motC}"
					...
					<input
					class="boutonRecherche" type="submit" name="action" value="Rechercher">
			</form>
			<br>
		...
		<div class="row rechercheAvancee" id="rechercheAvanceeDiv">
			...
			<button class="boutonRecherche" onclick="hideRechercheAvancee()">Moins de choix de recherche</button>
		</div>
		...
		<c:forEach items="${offres}" var="o">
			<div class="nonModale" data-toggle="modal"
				...
				<div class="row annonce">
					...
					<button type="button" class="btn btn-sm pull-right" id="openButton">En
						savoir plus</button>
				</div>
			</div>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<br>
							<div class="infosSupp text-justify"><img class="icones" src="<%=request.getContextPath()%>/images/locationIcon.png"/> ${o.ville}, ${o.pays} </div>
							<br>
							<div id="description" class="text-justify">${o.description}</div>
							<br>
							<div class="row">
							...
							<div id="infosPropriétaire">
								<c:forEach items="${infosProprio}" var="i">
									...
									<div class="infosSupp text-justify"><img class="icones" src="<%=request.getContextPath()%>/images/proprioIcon.png"/>
									 ${i.prenom} ${i.nom}
									 </div>
										<c:if test="${connected}">
